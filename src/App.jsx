  ...
  return <>
    ...
    <div style={{perspective:1600,marginBottom:22}} onClick={()=>setFlipped((f)=>!f)}>
      <div className={"card3d"+(flipped?" flip":"")} style={{position:"relative",minHeight:300}}>
        <div className="face" style={faceStyle(C.surface)}>
        ...
        <div className="face back" style={{...faceStyle(color+"10"),position:"absolute",inset:0,borderColor:color+"40",overflow:"auto"}}>
